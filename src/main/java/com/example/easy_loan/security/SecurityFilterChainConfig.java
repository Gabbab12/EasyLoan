package com.example.easy_loan.security;

import com.example.easy_loan.configuration.JwtFilterConfiguration;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(configurer->
                        configurer
                                ...
                                .requestMatchers(GET, "/api/messages/get-all-messages").authenticated()
                                .requestMatchers(GET, "/api/v1/kyc/update/**").authenticated()
                                .requestMatchers(POST, "/api/loan-repayment/**").authenticated()

                                .requestMatchers(GET,"/api/messages/conversations/**").authenticated()
                                ...
                                .requestMatchers(GET, "/api/v1/loan/loan-requests-list").hasRole("LENDER")
                                .requestMatchers(GET,"/api/v1/loan/view-loan-request").hasRole("LENDER")
